...
-- Expressions
compressExpression :: Dag dag => Expression pi a -> dag pi -> (LExpression a, dag pi)
...
compressExpressions :: Dag dag => [Expression pi a] -> dag pi -> ([LExpression a], dag pi)
compressExpressions = mapWithContext compressExpression

-- Constraints
compressConstraint :: Dag dag => Constraint pi a -> dag pi -> (LConstraint a, dag pi)
...
compressConstraints :: Dag dag => Constraints pi a -> dag pi -> (LConstraints a, dag pi)
